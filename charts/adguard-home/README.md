...
```console
helm install adguard-home roeidalm/adguard-home
```
...
helm install adguard-home \
  --set env.TZ="America/New York" \
    roeidalm/adguard-home
```

Alternatively, a YAML file that specifies the values for the above parameters can be provided while installing the chart.

```console
helm install adguard-home roeidalm/adguard-home -f values.yaml
```
...
- Open an [issue](https://github.com/roeidalm/helm-charts/issues/new/choose)
